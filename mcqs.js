...
function displayResults() {
  ...
  <button type="button" onclick="location.href='index.html'"style="padding: 10px 20px; font-size: 18px; background-color: #28a745; color: white; border: none; cursor: pointer; margin-top: 10px;">Back To Menu</a>
  <button type="button" onclick="location.href='result.html'" style="padding: 10px 20px; font-size: 18px; background-color: #28a745; color: white; border: none; cursor: pointer; margin-top: 10px;">View Results</button>
  </div>
  `;
